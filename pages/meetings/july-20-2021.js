...
function July202021(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes July 20, 2021</h1>
            ...
            <div className="py-4">
                ...
                <p>Last meeting's notes <a href="/meetings/july-06-2021" className="text-primary text-sm" > here</a> </p>

                <ul className="space-y-2">
                    <li>1. Funds transfer from core to CC <a href="#issue_1" className="text-primary">  <DownRightArrow/> </a> </li>
                    <li>2. Status of PR#606 Add the parameter confirmed_height to retrieve_tx owner_api method mimblewimble/grin-wallet#606<a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                    <li>3. Community pool<a href="#issue_3" className="text-primary"><DownRightArrow/>  </a> </li>
                    <li>4. Funding request for <a href="https://forum.grin.mw/t/request-for-funding-mwgrin-fr/8888/15" className="text-primary">mwgrin-fr </a><a href="#issue_4" className="text-primary"> <DownRightArrow/>  </a> </li>
                </ul>
            </div>
...
No OC members present here by any chance who can update us 😉
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. Status of PR#606 </h1>
...
* __dtavarez__ : I think we can continue with Community pool                    
            ...
            `}</ReactMarkdown>
                ...
                {/*Issue 3*/}
                <h1 id="issue_3"  className="text-xl mt-10 mb-4 px">3. Community Pool</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`
...
`}
                ...
                {/*Issue 4              */}
                <h1 id="issue_3b"  className="text-xl mt-10 mb-4 px">3.  Community Pool topic (continued)</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` 
...
`}
                ...
                {/*Issue 5              */}
                <h1 id="issue_5"  className="text-xl mt-10 mb-4 px">5. Funding request for <a href="https://forum.grin.mw/t/request-for-funding-mwgrin-fr/8888/15" className="text-primary">mwgrin-fr </a>  </h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` 
