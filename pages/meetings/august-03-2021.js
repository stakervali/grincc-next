...
function August032021(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes August 3, 2021</h1>
            ...
            <div className="py-4">
                ...
                <p>Last meeting's notes <a href="/meetings/july-20-2021" className="text-primary text-sm" > here</a> </p>

                <ul className="space-y-2">
                    <li>1. Funds transfer from core to CC <a href="#issue_1" className="text-primary">  <DownRightArrow/> </a> </li>
                    <li>2. Community pool <a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                    <li>3. Advancement of the CoinSwap Proposal <a href="#issue_3" className="text-primary"><DownRightArrow/> </a></li>
                    <li>4. Manual confirmation of an incoming transaction RFC<a className="text-primary" href="https://github.com/mimblewimble/grin-rfcs/pull/84"> Manual confirmation of an incoming transaction mimblewimble/grin-rfcs#84 </a> <a href="#issue_4" className="text-primary"><DownRightArrow/>  </a> </li>
                    <li>5. Community minining equipment purchase <a href="#issue_5" className="text-primary"> <DownRightArrow/>  </a> </li>
                </ul>
            </div>
            ...
            <div className="px-4" >
                ...
                {/*Issue 1*/}
                <h1 id="issue_1"  className="text-xl mt-10 mb-4 px">1.  Funds transfer from core to cc </h1>
...
* __anynomous__ : Anyhow, would be nice to check out the PGP method of the OC.
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. Community Pool</h1>
...
* __mcmmike__ : if you solo-mining think about joining.          
            ...
            `}</ReactMarkdown>
                ...
                {/*Issue 3*/}
                <h1 id="issue_3"  className="text-xl mt-10 mb-4 px">3. Advancement of the CoinSwap Proposal </h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`
...
`}
                ...
                {/*Issue 4              */}
                <h1 id="issue_4"  className="text-xl mt-10 mb-4 px">4. Manual confirmation of an incoming transaction RFC</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` 
...
`}
                ...
                {/*Issue 5              */}
                <h1 id="issue_5"  className="text-xl mt-10 mb-4 px">5. Community minining equipment purchase </h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` 
