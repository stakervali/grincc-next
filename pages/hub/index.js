            ...
            <div className="py-4">
                ...
                <ul className="pl-4 pt-2 space-y-4" >
                    <li><RhombusItem />  <b>Grin official website: </b> Find all information and links to node and wallet software you might be searching for.
                     ...
                     <li><RhombusItem />  <b>Grin documentation: </b> Your journey down the rabbit hole starts here! Learn about where Grin comes from, Mimblewimble, Pedersen commitments, Elliptic Curve cryptography as well as practical tutorials on how to install and use the grin node software and grin-wallet.
                         <p className="pl-8">
                            <a href="https://docs.grin.mw/" className="text-primary">https://docs.grin.mw/</a>
                        </p>
                    </li>

                     <li><RhombusItem />  <b> Grinflation</b>
                        <p className="pl-8">
                            A great website that shows all the economics around Grins's Fair 1   ツ per second supply rate, its inflation, total supply, market cap and price now and in times to come.
