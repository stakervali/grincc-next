...
export default function May102022(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes March 10, 2022</h1>
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem /> Current situation of PIBD has been discussed. @yeastplume will work on RFC.</li>
                    <li><RhombusItem /> Grin meet-up ideas/details has been discussed like location/date.</li>
                    <li><RhombusItem /> Grin-wallet contract prototype can be tested by community.</li>
                    <li><RhombusItem /> Grin CC's last year performance has been reviewed and future projections has been made. </li>
                </ul>
            </div>
            ...
            <div className="py-4">
                ...
                <p>Last meeting's notes <a href="/meetings/april-26-2022" className="text-primary text-sm" > here</a> </p>

                <ul className="space-y-2">
                    <li>1. Open discussions <a href="#issue_1" className="text-primary">  <DownRightArrow/> </a> </li>
                    <li>2. Discuss the outcome of a CC reflection on the past year and brainstorm on future direction of the CC <a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                </ul>
            </div>
            ...
            <div className="px-4" >
                ...
                {/*Issue 1*/}
                <h1 id="issue_1"  className="text-xl mt-10 mb-4 px">1. Open discussions</h1>
...
`}
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. Discuss the outcome of a CC reflection on the past year and brainstorm on future direction of the CC</h1>
...
`}
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem />PIBD testing and RFC.</li>
                    <li><RhombusItem />Spend micro funds on documentation and video documentation as small incentives.</li>
                    <li><RhombusItem />Explore ideas (date/city location ) for Grin meet-up.</li>
                    <li><RhombusItem />Attend  Bitcoin Wednesday, a monthly meetup in Amsterdam.</li>
