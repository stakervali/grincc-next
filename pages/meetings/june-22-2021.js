...
function June222021(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes June 22, 2021</h1>
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li>1. Status of the multi-sig address <a href="#issue_1" className="text-primary">  <DownRightArrow/> </a> </li>
                    <li>2. New github organisation links, etc <a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                    <li>3. Status of spending rules<a href="#issue_3" className="text-primary"><DownRightArrow/>  </a> </li>
                    <li>4. Request for funding : @mwgrin_fr video tutorials for wallet-cli usage scenarios<a href="#issue_4" className="text-primary"> <DownRightArrow/>  </a> </li>
                    <li>5. Grin fund for mining<a href="#issue_5" className="text-primary"> <DownRightArrow/>  </a> </li>
                </ul>
            </div>
            ...
            <div className="px-4" >
                ...
                {/*Issue 1*/}
                <h1 id="issue_1"  className="text-xl mt-10 mb-4 px">1. Status of the multi-sig address  </h1>
...
* _hendi_ : Nothing new for me                    
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. New Github Organization links, etc</h1>
...
* _mcmmike_ :_anynomous_ can you proceed with (3) spending rules please while I rename it                    
            ...
            `}</ReactMarkdown>
                ...
                {/*Issue 3*/}
                <h1 id="issue_3"  className="text-xl mt-10 mb-4 px">3. Spending Rules</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`
...
`}
                ...
                {/*Issue 4              */}
                <h1 id="issue_4"  className="text-xl mt-10 mb-4 px">4. Request for funding : @mwgrin_fr video tutorials for wallet-cli usage</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` 
...
`}
                ...
                {/*Issue 5              */}
                <h1 id="issue_5"  className="text-xl mt-10 mb-4 px">5. Grin fund for mining </h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` 
