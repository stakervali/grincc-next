...
export default function February012022(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes March 15, 2021</h1>

            <p className="py-8">Community Council (CC) meeting held @ 10 UTC in grincoin#general channel on Keybase. Meeting lasted 90 min.
            ...
            {/* VOTING RESULTS */}
            <div className="py-4">
                <h1 className="header-2">Decisions</h1>

                <ul className="space-y-2">
                    <li>@jankie1800 funding request (Mar-May 2022) __Approved__  </li>
                    <li>@cekickafa funding request (Mar-May 2022) __Approved__  </li>
                </ul>
            </div>
            ...
            <div className="py-4">
                ...
                <p>Last meeting's notes <a href="/meetings/march-01-2022" className="text-primary text-sm" > here</a> </p>

                <ul className="space-y-2">
                    <li>1. Maintaining Grin Telegram+Keybase-discord bridge service <a href="#issue_1" className="text-primary">  <DownRightArrow/> </a> </li>
                    <li>2. Request for funding @jankie <a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                    <li>3. Request for funding @cekickafa<a href="#issue_3" className="text-primary"><DownRightArrow/>  </a> </li>
                    <li>4. Organizing a community sub-team with focus on the increase of Grin adoption.<a href="#issue_4" className="text-primary"> <DownRightArrow/>  </a> </li>
                    <li>5. Increasing Bisq awareness in Grin Community.<a href="#issue_5" className="text-primary"> <DownRightArrow/>  </a> </li>
                </ul>
            </div>
            ...
            <div className="px-4" >
                ...
                {/*Issue 1*/}
                <h1 id="issue_1"  className="text-xl mt-10 mb-4 px">1. Maintaining Grin Telegram+Keybase-discord bridge service</h1>
 ...
 * __jankie1800__ : I'm greatly appreciative of this community support. Thank you :) 🙏`}
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. <Link href="https://forum.grin.mw/t/request-for-funding-groundskeeper-jankie-mar-may-2022/9623/6" >Request for funding </Link> @jankie</h1>
 ...
 * __jankie1800__ : I'm greatly appreciative of this community support. Thank you :) 🙏 
            ...
            `}</ReactMarkdown>
                ...
                {/*Issue 3*/}
                <h1 id="issue_3"  className="text-xl mt-10 mb-4 px">3. <Link href="https://forum.grin.mw/t/request-for-funding-cekickafa-as-groundskeeper-mar-may-2022/9641/1" >Request for funding </Link> @cekickafa</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`__anynomous__ : Lets continue with our next agenda point:
...
`}
                ...
                {/*Issue 4              */}
                <h1 id="issue_4"  className="text-xl mt-10 mb-4 px">4. Organizing a community sub-team with focus on the increase of Grin adoption.</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`__anynomous__ : Some suggestions for items that could be included:
...
`}
                ...
                {/*Issue 5              */}
                <h1 id="issue_5"  className="text-xl mt-10 mb-4 px">5. Increasing Bisq awareness in Grin Community  </h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`__dtavarez__ : do we have enough time to discuss "Increasing Bisq awareness in Grin Community."? or should be move to the next meeting in two weeks?
...
`}
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem />Follow up "Community Sub-Teams" into next community meeting.</li>
                    <li><RhombusItem />BISQ needs liquidity support.</li>
                    <li><RhombusItem />@cekickafa working out BISQ tutorial.</li>
