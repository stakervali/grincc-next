...
export default function September132022(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes September 13, 2022</h1>

            <p className="py-8">Community Council (CC) meeting held @ 15 UTC in grincoin#general channel on Keybase. Meeting lasted 59 min.
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem /> Biweekly Meeting schedule affirmed. </li>
                    <li><RhombusItem /> Bounty amount for writing a CFFI wrapper of secp256k1-zkp fork has been discussed. </li>
                    <li><RhombusItem /> Retroactive Grants like idea proposal has been discussed. </li>
            ...
            <div className="py-4">
                ...
                <p>Last meeting's notes <a href="/meetings/august-30-2021" className="text-primary text-sm" > here</a> </p>

                <ul className="space-y-2">
                    <li>1. Community Biweekly meeting Schedule   <a href="#issue_1" className="text-primary"> <DownRightArrow/> </a> </li>
                    <li>2. Bounty for writing a CFFI wrapper of secp256k1-zkp fork  <a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                    <li>3. Retroactive Grants like idea <a href="#issue_3" className="text-primary"><DownRightArrow/>  </a> </li>
                </ul>
            </div>
            ...
            <div className="px-4" >
                ...
                {/*Issue 1*/}
                <h1 id="issue_1"  className="text-xl mt-10 mb-4 px">1. Community Biweekly meeting Schedule</h1>
...
👍   cekickafa, defistaker, phyro ,dtavarez, deeev.`}
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. Bounty for writing a CFFI wrapper of secp256k1-zkp fork</h1>
...
deeev, anonymous, cekickafa, renzokuken 👍
            `}</ReactMarkdown>
                ...
                {/*Issue 3*/}
                <h1 id="issue_3"  className="text-xl mt-10 mb-4 px">3. Retroactive Grants like idea</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{` (https://blog.opengsn.org/taking-retroactive-grants-from-concept-to-practice-at-gitcoin-grants-round-11-649497d08519)
...
`}
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem /> Community meeting schedule stays same.</li>
                    <li><RhombusItem /> Bounty for writing a CFFI wrapper of secp256k1-zkp fork idea accepted.</li>
                    <li><RhombusItem /> Retroactive Grants like idea will be discussed more. </li>
