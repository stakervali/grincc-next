...
export default function March012022(props) {
    return (
        <section  className="my-container ">
            <h1 className="header-1" >Council Meeting Notes March 1, 2022</h1>
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem />  Bounties on video tutorials for trading on all exchanges will be discussed on forum.</li>
                    <li><RhombusItem />  Groundkeepers will keep a record of log and activities.</li>
                    <li><RhombusItem />  Grincc website is ready to be deployed.</li>
                </ul>
            </div>
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li>1. Provide more exposure to Bisq and other exchanges <a href="#issue_1" className="text-primary">  <DownRightArrow/> </a> </li>
                    <li>2. Overview on Grin CC github page and web site <a href="#issue_2" className="text-primary"><DownRightArrow/> </a></li>
                    <li>3. Bounties for training videos on Bisq and Tradeogre<a href="#issue_3" className="text-primary"><DownRightArrow/>  </a> </li>
                    <li>4. Request for funding Groundskeeper @jankie / Mar-May 2022<a href="#issue_4" className="text-primary"> <DownRightArrow/>  </a> </li>
                </ul>
            </div>
            ...
            <div className="px-4" >
                ...
                {/*Issue 1*/}
                <h1 id="issue_1"  className="text-xl mt-10 mb-4 px">1. Provide more exposure to Bisq and other exchanges</h1>
...
__anynomous__ : At least I think the second solution could be useful and only spend some minor amounts of Grin. What do you all think, would bounties for video tutorials fit with the objective of the Grin Community Council?
 ...
 __defistaker__ : It sure fits IMO`}
                ...
                {/*Issue 2*/}
                <h1 id="issue_2"  className="text-xl mt-10 mb-4 px">2. Overview on Grin CC github page and web site</h1>
...
__defistaker__ : I will setup and deploy tonight. 
            ...
            `}</ReactMarkdown>
                ...
                {/*Issue 3*/}
                <h1 id="issue_3"  className="text-xl mt-10 mb-4 px">3. Bounties for training videos on Bisq and Tradeogre</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`__anynomous__ : In my opinion as Community Council we should do more of these activities that involve minor amounts of funds,  but which are actually very useful for Grin users in general, having video tutorials for exchanges, wallets etc.
...
__dtavarez__ : countries are lifting restrictions, that means probably we could start with in-person meetings this year
...
`}
                ...
                {/*Issue 4              */}
                <h1 id="issue_4"  className="text-xl mt-10 mb-4 px">4. Request for funding Groundskeeper @jankie / Mar-May 2022</h1>
                <ReactMarkdown  className="meeting-text"  remarkPlugins={[remarkGfm]}  >{`https://forum.grin.mw/t/request-for-funding-groundskeeper-jankie-mar-may-2022/9623
...
__dtavarez__ : when it says: "facilitate developer outreach initiative" what do you mean with that? and what have been achieved for instance?
...
__dtavarez__ : my other concern with trying to reach developers is that there is not a "guarantee hiring", this could lead to confusion 
...
`}
            ...
            <div className="py-4">
                ...
                <ul className="space-y-2">
                    <li><RhombusItem />Follow up community bounties forum post discussion - see if bounties are needed and as such what amounts would be valid tokens of appreciation..</li>
                    <li><RhombusItem />GrinCC website green light to life.</li>
                    <li><RhombusItem />Include updated exchange info on community website.</li>
                </ul>
            </div>
